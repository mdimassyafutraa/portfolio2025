    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[25ch]">Get in Touch for Collaboration</h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[50ch]">Let's connect and bring your project ideas to life—looking forward to collaborating on something amazing!</p>
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon, alt }) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 transition-[background-color,color] hover:bg-[#1B4242] hover:text-zinc-50 active:bg-[#1B4242] rounded-lg"
        ...
        <form action="https://getform.io/f/alllpmpa" method="POST" className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:grid-cols-2 md:gap-2 md:items-center">
            <div className="mb-4">
              <label htmlFor="name" className="label">
                Name
              </label>
              <input type="text" name="name" id="name" className="text-field" required autoComplete="name" placeholder="Your name" />
            </div>
            <div className="mb-4">
              <div className="">
                ...
                <input type="email" name="email" id="email" className="text-field" required autoComplete="email" placeholder="email@example.com" />
              </div>
            </div>
          </div>
